...
Only major difference in this iteration is including song after every click.
The frequency makes it a little diffiult to hear, but if you click and 
pay close attention, you hear another sound. 
...
function draw() {
  ...
  ellipse(270, 200, diameter0*100, diameter0*100);
  //ellipse diameter0 group
  ellipseMode(RADIUS);
  fill(123,90,100);
  ellipse(840, 600, diameter0*50, diameter0*50);
...
//  wheel.draw();
  ...
  ellipseMode(RADIUS);    
  fill(170,155,0);
  ellipse(600, 200, diameter1, diameter1);
  //ellipse 2
  ellipse(RADIUS);
  fill(100);
  ellipse(100, 500, diameter1, diameter1);
    
  //ellipse diameter2 group
  //ellipse 1
  ellipseMode(RADIUS);
  fill(160,30,95);
  rect(350, 100, diameter2, diameter2);
  //ellipse 2
  ellipseMode(RADIUS);
  fill(85,178,90);
  rect(460, 500, diameter2*5, diameter2*5);
